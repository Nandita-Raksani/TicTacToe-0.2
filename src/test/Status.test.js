...
describe(("<Status/> component"), () => {
    ...
    beforeEach(() => {
        const board = ['', '', '', '', '', '', '', '', ''];
        wrapper = shallow(<Status currentPlayer='X' board={board} onPlayerWin={jest.fn()} isGameOver={false} />);
    });
...
describe(("<Status/> functionality"), () => {
    it("should render the player's turn correctly", () => {
        ...
        const wrapper = mount(<Status currentPlayer='X' board={Array(9).fill('')} onPlayerWin={jest.fn()} isGameOver={false} />);
    ...
    it("should declare X as winner if first row is completely filled by X ", () => {
        ...
        const wrapper = mount(<Status currentPlayer='X' board={board} onPlayerWin={jest.fn()} isGameOver={false} />);
    ...
    it("should declare O as winner if first row is completely filled by O ", () => {
        ...
        const wrapper = mount(<Status currentPlayer='O' board={board} onPlayerWin={jest.fn()} isGameOver={false} />);
    ...
    it("Should not allow next turn to be played on game over", () => {
        ...
        const wrapper = mount(<Status currentPlayer='O' board={board} onPlayerWin={onPlayerWonMockFn} isGameOver={false} />);
